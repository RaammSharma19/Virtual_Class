<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="UpdateAssignment.aspx.cs" Inherits="Assignments_UpdateAssignment" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Update Assignment Status : Virtual Office</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    ...
    <div id="container">
        ...
        <ul>
            ...
            <li><span class="auto-style5">Enter Roll No. and Subject to Udate status.</span></li>
            <li><marquee class="auto-style9">  This Will Set Students Assignment as Completed. </marquee></li>
            ...
            <li class="auto-style7">
                <asp:TextBox ID="subject" runat="server" CssClass="round" placeholder=" Enter Subject " required="true"></asp:TextBox>
            </li>
            <li>
